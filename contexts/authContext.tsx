...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const register = async (email: string, password: string, name: string, isBuyer: boolean) => {
    try {
      ...
      await setDoc(doc(firestore, "users", response.user.uid), { 
        ...
        isBuyer // ✅ Save buyer/seller choice
      });
    ...
    try {
      ...
      if (docSnap.exists()) {
        ...
        setUser({
          ...
          isBuyer: data.isBuyer ?? true // ✅ load buyer/seller flag
        });
      }
    } catch (error: any) {

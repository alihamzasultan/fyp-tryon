...
const TransactionList = ({
    ...
    useEffect(() => {
        const loadCurrencySymbol = async () => {
            const symbol = await AsyncStorage.getItem('selectedCurrencySymbol');
                ...
                <FlashList
                    ...
                    renderItem={({ item, index }) =>
                        <TransactionItem
                            ...
                            currencySymbol={currencySymbol}  // <-- Pass currencySymbol here
                        />
                    }
...
const TransactionItem = ({
    ...
    index,
    handleClick,
    currencySymbol // <-- Accept the currencySymbol prop
}: TransactionItemProps & { currencySymbol: string }) => {  // <-- Add type for currencySymbol
        ...
        <Animated.View entering={FadeInDown.delay(index * 100).springify().damping(14)}>
            <TouchableOpacity style={styles.row} onPress={() => handleClick(item)}>
                ...
                <View style={styles.amountDate}>
                    <Typo fontWeight={"500"} color={item?.type == "income" ? colors.primaryLight : colors.rose}>
